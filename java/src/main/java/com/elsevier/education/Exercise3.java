...
/**
 ...
 implementations provide in Object are sufficient. Note that the equals would never be true because the faulty hashCode
 method would hae not had a hash code that could be relied on to return the same hash for the same object.
