...
//        }
        ...
        @Override //fixed hashCode()
        public int hashCode() {
            return id.hashCode();
        }

        @Override
        public boolean equals(Object other) { // a more accurate implementation of equals()
            return (null != other) && (other instanceof Person) && (id.equals(((Person)other).id));
        }
    }
}